            ...
            <div class="col-md-12 ">
                <div class="card card-nav-tabs text-center my-5">
                    <div class="card-header card-header-rose">
                        <h4 class="card-title">Editar Quarto de {{$reserva->first()->nome}}</h4>
                    </div>

                    <div class="card-body align-content-center">
                        <form class="form" method="post" action="{{route('hospedes.editarQuarto')}}">
                            ...
                            <div class="text-right">
                                ...
                                @foreach($andares as $andar)
                                    <a type="buttton" href="{{ route('hospedes.filtrar', array($reserva->first()->id, $andar->andar)) }}" class="btn btn-round btn-info btn-fab">
                                        {{$andar->andar}}
                                    </a>
                                @endforeach
                                <a type="buttton" href="{{ route('hospedes.editaQuarto', $reserva->first()->id )}}" class="btn btn-round btn-info btn-fab">
                                    -
                                </a>
                            </div>
                            @foreach($andares as $andar)
                                                                ...
                                                                <div class="card-body">
                                                                    <div class="form-check form-check-radio">
                                                                        <label class="form-check-label">
                                                                            <input class="form-check-input" type="radio" name="radio" id="exampleRadios2" value="{{$quarto->id}}" @if($reserva->first()->numero == $quarto->numero) checked @endif required>
                                                                            Selecionar quarto
                                                                            <span class="circle">
                                                        ...
                                                        <div class="col-md-4">
                                                            <div class="card">
                                                                ...
                                                                <div class="card-body">
                                                                    <div class="form-check form-check-radio">
                                                                        <label class="form-check-label">
                                                                            <input class="form-check-input" type="radio" disabled name="radio" id="exampleRadios2" value="{{$quarto->id}}" @if($reserva->first()->numero == $quarto->numero) checked @endif  required>
                                                                            Selecionar quarto
                                                                            <span class="circle">
                                                                            <span class="check"></span>
                                                                        </span>
